...
public final class XmlShapeParser {
    ...
    private static Drawable parseBasicTransformDrawable(Context context, XmlPullParser xpp, String type) throws Exception {
        Drawable child = parseNestedItemDrawable(context, xpp);
        if (child == null) return null;
    ...
    @Nullable
    private static Drawable parseNestedItemDrawable(Context context, XmlPullParser xpp) throws Exception {
    ...
    private static int shapeTypeFromString(@Nullable String value) {
        ...
        switch (value) {
            ...
            case "line": return GradientDrawable.LINE;
            case "ring": return GradientDrawable.RING;
            default: return GradientDrawable.RECTANGLE;
        }
    }
    ...
    private static int stateNameToAttr(String name) {
        ...
        switch (name) {
            case "state_pressed": return android.R.attr.state_pressed;
            case "state_enabled": return android.R.attr.state_enabled;
            case "state_selected": return android.R.attr.state_selected;
            case "state_checked": return android.R.attr.state_checked;
            case "state_checkable": return android.R.attr.state_checkable;
            case "state_focused": return android.R.attr.state_focused;
            case "state_activated": return android.R.attr.state_activated;
            case "state_hovered": return android.R.attr.state_hovered;
            case "state_window_focused": return android.R.attr.state_window_focused;
            default: return 0;
        }
    }
